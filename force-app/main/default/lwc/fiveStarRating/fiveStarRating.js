...
export default class FiveStarRating extends LightningElement {
  ...
  loadScript() {
      ...
      Promise.all([
                    ...
                    this.initializeRating();
                                    ...
                                    const raiseAToast = new ShowToastEvent ({title:ERROR_TITLE ,
                                                                            variant:ERROR_VARIANT,
                                                                            });
                                    this.dispatchEvent(raiseAToast);                                                 
                                });
  }
  ...
  ratingChanged(rating) {
      const eventForRating = new CustomEvent ('ratingchange',{detail:{rating:rating}});
      this.dispatchEvent (eventForRating);
  }
}